...
const social_data: {
  ...
  {
    id: 2,
    link: 'https://twitter.com/vocalify_ai',
    icon: 'flaticon-twitter',
    title: 'twitter',
  },
  {
    id: 3,
    link: 'https://instagram.com/vocalify.ai',
    icon: 'flaticon-instagram',
    title: 'instagram',
  },
  {
    id: 4,
    link: 'https://youtube.com/@vocalify',
    icon: 'flaticon-youtube',
    title: 'youtube',
  },
  {
    id: 5,
    link: 'https://discord.gg/nzZ3yVGrJK',
...
const SocialArea = () => {
  return (
    <section
      ...
      style={{ backgroundImage: `url(${social_bg.src})` }}
    >
