...
const road_map_lists: IRoadMap[] = [
    ...
    lists: [
      {
        active: true,
        text:
          'Beta Launch: Initial testing phase for core functionalities.\n' +
    ...
    lists: [
      {
        active: true,
        text:
          'Platform Launch: Official release of the Vocalify platform.\n' +
  ...
  },
  {
    id: 3,
    active: false,
    title: 'Q1-Part-2 2024',
    lists: [
      {
        active: true,
        text:
          'Community Showcase: Monthly spotlight on exceptional projects and contributions.\n' +
    ...
    lists: [
      {
        active: true,
        text:
          'Mobile App Launch: Release of Vocalify mobile application for iOS and Android.\n' +
    ...
    lists: [
      {
        active: true,
        text:
          'Voice Customization Suite: Advanced tools for fine-tuning voice models.\n' +
    ...
    lists: [
      {
        active: true,
        text:
          'Continuous Improvement: Ongoing updates based on user feedback and technological advancements.\n' +
              ...
              <div className="row">
                <div className="col-xl-5 col-lg-6">
                  <div className="roadMap__content">
                    ...
                    <p>
                      Our roadmap is a living document that outlines the key
                      milestones we aim to achieve as we continue to innovate
                      and expand the Vocalify platform. We are committed to
                      delivering exceptional value to our community, and this
                      roadmap serves as our strategic blueprint for the journey
                      ahead.
                    </p>
